...
API_KEY=bhk126T74IY5&sdfBNdfg35&
for i in `seq $SMS_MESSAGES` ; do
    echo "screen -S parseAndSend -d -m python $PROGRAM \"\${SMS_${i}_NUMBER}\" \"\${SMS_${i}_TEXT}\" true&"
    eval "screen -S parseAndSend -d -m python $PROGRAM \"\${SMS_${i}_NUMBER}\" \"\${SMS_${i}_TEXT}\" true&"
