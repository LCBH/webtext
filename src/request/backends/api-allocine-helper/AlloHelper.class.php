...
//		echo "data empty\n";   
		    ...
		    {
// 			echo "Allodata exists!\n";
// 			echo "---".$this->utf8Decode."---".PHP_EOL;
// 			foreach ($data as $k => $v)
// 			{						
// 				echo "---".$k." => ".$v."---".PHP_EOL;
//                         }
// 			echo "-------------------------\n";
// 			foreach($data['feed'] as $t => $t1)
// 			{
// 				echo $t." => ".$t1."\n";
// 				if (strcmp($t,"theaterShowtimes")==0)
// 				{
// //					var_dump($t1);
